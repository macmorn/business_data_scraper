    ...
    with _get_conn() as conn:
        conn.execute(
            """UPDATE companies SET
                ...
                financials_json=?, revenue_notes=?, employees_notes=?,
                public_funding_total=?,
                corporate_purpose=?, industry_code=?, category=?, northdata_url=?,
            ...
            (
                ...
                record.financials_json, record.revenue_notes, record.employees_notes,
                record.public_funding_total,
                record.corporate_purpose, record.industry_code, record.category, record.northdata_url,
                record.ceo_name, record.ceo_linkedin_url, record.ceo_current_title,
                record.ceo_career_summary, record.ceo_confidence,
                record.corporate_structure_summary,
